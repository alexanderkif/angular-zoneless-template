...
```bash
psql "postgresql://postgres.yxiirmcplqkwjwknsfue:hiUVNzJpRTG0ZRT9@aws-1-us-east-1.pooler.supabase.com:6543/postgres" -f supabase/migrations/20260121_posts_comments.sql
```
